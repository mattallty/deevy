...
import {
  AgentSchema,
  cascadeReinstateAgents,
  cascadeSuspendAgents,
  createAgent,
  handleTaken,
  liftCascade,
  listAgents,
 ...
 */
async function requireSponsoredAgent(context: ContextFor<"member">, memberId: string) {
  const found = await context.db.query.member.findFirst({
...
async function reloadAgent(context: ContextFor<"member">, memberId: string) {
...
async function grantedProjects(context: ContextFor<"member">, memberId: string) {
