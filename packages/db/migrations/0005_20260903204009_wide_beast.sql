-- Generated from drizzle/20260903204009_wide_beast/migration.sql by `vp run db#generate:d1`.
...
CREATE UNIQUE INDEX `issue_number_uidx` ON `issue` (`project_id`,`number`);

CREATE INDEX `issue_projectId_stateId_idx` ON `issue` (`project_id`,`state_id`);
