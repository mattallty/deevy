-- Generated from drizzle/20260903211357_mushy_venom/migration.sql by `vp run db#generate:d1`.
...
CREATE INDEX `issue_label_labelId_idx` ON `issue_label` (`label_id`);

CREATE UNIQUE INDEX `label_uidx` ON `label` (`workspace_id`,`scope`,`name`);
