-- Generated from drizzle/20260904061424_mute_epoch/migration.sql by `vp run db#generate:d1`.
...
ALTER TABLE `workflow_state` ADD `trigger_agent_member_id` text REFERENCES member(id) ON DELETE SET NULL;
