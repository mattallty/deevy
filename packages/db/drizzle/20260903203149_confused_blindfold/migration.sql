...
--> statement-breakpoint
CREATE UNIQUE INDEX `project_key_uidx` ON `project` (`workspace_id`,`key`);--> statement-breakpoint
...
CREATE INDEX `team_member_memberId_idx` ON `team_member` (`member_id`);--> statement-breakpoint
