...
INSERT INTO `__new_issue_link`(`id`, `issue_id`, `kind`, `url`, `title`, `ref`, `run_id`, `created_by`, `created_at`) SELECT `id`, `issue_id`, `kind`, `url`, `title`, `ref`, `run_id`, `created_by`, `created_at` FROM `issue_link`;--> statement-breakpoint
DROP TABLE `issue_link`;--> statement-breakpoint
ALTER TABLE `__new_issue_link` RENAME TO `issue_link`;--> statement-breakpoint
