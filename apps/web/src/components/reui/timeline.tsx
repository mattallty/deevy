/**
 * ReUI `timeline` (https://reui.io/docs/timeline), added 2026-09-05 with
 * `pnpm dlx shadcn@latest add @reui/timeline` from the base-mira style, so it
 * is the Base UI build (useRender + mergeProps, no Radix). MIT, (c) 2025
 * Keenthemes Inc. Local changes: this header only; callers colour the rail
 * through className (.claude/skills/deevy-ui, "Registries").
 */
