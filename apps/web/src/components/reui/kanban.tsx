/**
 * From the ReUI registry — `@reui/kanban`, the Base UI build (`/r/base-mira/kanban`), added 2026-09-05
 * with `pnpm dlx shadcn@latest add @reui/kanban`. MIT (keenthemes/reui). Ours to edit; re-adding brings
 * the upstream back (.claude/skills/deevy-ui, "Registries").
 */
...
function Kanban<T>({
  ...
  const columnIds = useMemo(() => {
    ...
    // Vite, not Node: the browser build has no `process`.
