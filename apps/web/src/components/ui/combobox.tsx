...
function ComboboxChip({
  ...
  showRemove?: boolean;
  /** The remove button's accessible name, e.g. "Remove backend"; without it the button is nameless. */
  removeLabel?: string;
}) {
  return (
