...
// The round-3 palette candidates ride along in development only (src/dev/palette-switcher.tsx).
if (import.meta.env.DEV) void import("./dev/palette-candidates.css");
